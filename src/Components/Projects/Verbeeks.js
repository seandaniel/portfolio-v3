    ...
    <section>
      <div className="project-button-container">
        <div className="project-content project-content-3">
          ...
          <p>Verbeek's services everyone from the home gardener to the largest farm properties across their residing county. Built and designed through Liquid and Sass with the demographic in mind, showcasing the company's brand and unique products.</p>
          <h4>Liquid / Sass / Vanilla JavaScript</h4>
